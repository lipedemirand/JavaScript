...
console.log(`A multiplicação de ${valor01} po ${valor02} é ${valor01 * valor02}`);

// Métodos de Strings 
console.clear();
const strings01 = 'Instituto da Oportunidade Social';
...
const strCopy = str1. slipt();
console.log(stryCopy);
...
// Metódos de busca em strings
console.clear();
let frase = 'Sou um aluno do IOS e o IOS é bom!';
...
console.log(frase.startsWith('a')); // Falso - retornafalse
